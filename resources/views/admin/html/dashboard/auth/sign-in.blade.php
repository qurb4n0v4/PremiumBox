                  ...
                  <div class="col-md-10">
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body z-3 px-md-0 px-lg-4">
                            <a href="{{ url('index') }}" class="navbar-brand d-flex align-items-center mb-3">
                            </a>
                            ...
                            <form action="{{ route('admin.login') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 d-flex justify-content-between">
                                        ...
                                        <a href="{{ route('recover-password') }}">Forgot Password?</a>
                                    </div>
                                </div>
                                ...
                                <p class="mt-3 text-center">
                                    Don’t have an account? <a href="{{ route('admin.register') }}" class="text-underline">Click here to sign up.</a>
                                </p>
                            </form>
                        </div>
                     </div>
