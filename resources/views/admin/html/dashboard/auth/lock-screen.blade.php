            ...
            <div class="col-md-6 p-0">
                  <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                     <div class="card-body z-3">
                         <a href="{{ url('index.blade.php') }}" class="navbar-brand d-flex align-items-center mb-3">

                        </a>
                         <img src="{{ asset('assets/admin/images/avatars/01.png') }}" class="rounded avatar-80 mb-3" alt="">
               ...
               <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
                   <img src="{{ asset('assets/admin/images/auth/04.png') }}" class="img-fluid gradient-main animated-scaleX" alt="images">
               </div>
            </div>
      </section>
      </div>
