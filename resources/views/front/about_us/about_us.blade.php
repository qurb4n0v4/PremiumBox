    ...
    <div class="custom-about-container my-3">
        ...
        <div class="section-about-us row align-items-center" style="background-color: #ffffff;">
            <div class="col-lg-6 text-center">
                <img src="{{ 'assets/front/img/haqqimizda.webp' }}" alt="GiftBox" class="about-us-image img-fluid">
            </div>
            <div class="col-lg-6">
        ...
        <div class="shall-we-begin-section row">
            <div class="row align-items-center">
                ...
                <!-- Right Image -->
                <div class="col-lg-6 text-center">
                    <img src="{{ 'assets/front/img/qutu.jpg' }}" alt="Gift Boxes" class="img-fluid rounded shall-we-begin-image">
                </div>
            </div>
        </div>
    </div>
